        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">View Fees (TUITION FEE)</span>
                </div>
...
$sql = "SELECT DISTINCT studentNo, studentName, section, feeType, amountPaid, dueDate, datePaid, status FROM fees_info WHERE feeType = 'TUITION_FEE'  ORDER BY studentName";
