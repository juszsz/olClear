...
<head>
    ...
    <title>Admin-Viewing Fees (PROM FEE)</title>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">View Fees (PROM FEE)</span>
                </div>
...
$sql = "SELECT DISTINCT studentNo, studentName, section, feeType, amountPaid, dueDate, datePaid, status FROM fees_info WHERE feeType = 'PROM_FEE'  ORDER BY studentName";
