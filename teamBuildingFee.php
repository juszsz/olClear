...
<head>
    ...
    <title>Admin-Viewing Fees (TEAM BUILDING FEE)</title>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">View Fees (TEAM BUILDING FEE)</span>
                </div>
...
$sql = "SELECT DISTINCT studentNo, studentName, section, feeType, amountPaid, dueDate, datePaid, status FROM fees_info WHERE feeType = 'TEAM_BUILDING'  ORDER BY studentName";
